...
BrandingText "野菜API 0.4.13 Windows 修复版"
Icon "${APP_ICON}"
...
VIAddVersionKey /LANG=2052 "FileVersion" "0.4.13"
VIAddVersionKey /LANG=2052 "ProductVersion" "0.4.13"
...
Function .onInit
  FindWindow $0 "" "野菜API"
  StrCmp $0 0 done
  MessageBox MB_ICONEXCLAMATION|MB_OKCANCEL "检测到野菜API正在运行。请先在应用中选择完全退出；确认进程已结束后，再继续安装修复版。" IDOK done IDCANCEL cancel
cancel:
  Abort
done:
FunctionEnd
...
Section "安装野菜API" SEC_MAIN
  ...
  WriteRegStr HKCU "Software\Microsoft\Windows\CurrentVersion\Uninstall\com.yeschoy.desktop" "DisplayVersion" "0.4.13"
